...
export default function Outcome () {
    ...
    function addOutcome (event) {
        ...
        const promise = axios.post('https://mywallet-13.herokuapp.com/entries', {value: outcome.value, description: outcome.description, type: "negative"}, {headers: {Authorization: `Bearer ${user.token}`}});
        promise.then((res) => {
            navigate('/menu')
        })
        promise.catch((err) => {
